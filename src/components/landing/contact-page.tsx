        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              ...
              <Button variant="outline" className="w-full justify-center py-4 font-bold">Login</Button>
              <Button className="w-full justify-center bg-[#004D40] text-white py-4 font-bold shadow-lg shadow-[#004D40]/20">Get Started</Button>
            </motion.div>
          )}
        </AnimatePresence>
      </header>
            ...
            <form onSubmit={handleSubmit} className="mx-auto max-w-[1000px]">
              <div className="grid gap-x-8 gap-y-6 md:grid-cols-2">
                ...
                <div className="flex flex-col gap-2">
                  <label htmlFor="fullname" className="text-[18px] font-[500] text-[#0C0E0D] ml-1">
                    Fullname
                  </label>
                  <input
                    id="fullname"
                    ...
                    className={`rounded-xl border ${errors.fullname ? "border-[#FF5630]" : "border-gray-200"} bg-white px-5 py-4 text-base text-[#1A1A1A] placeholder-[#919EAB] outline-none transition-all focus:border-[#004D40] focus:ring-4 focus:ring-[#004D40]/5`}
                  />
                  {errors.fullname && (
                ...
                {/* Email */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="email" className="text-[18px] font-[500] text-[#1A1A1A] ml-1">
                    Email Address
                  </label>
                  <input
                    id="email"
                    ...
                    className={`rounded-xl border ${errors.email ? "border-[#FF5630]" : "border-gray-200"} bg-white px-5 py-4 text-base text-[#1A1A1A] placeholder-[#919EAB] outline-none transition-all focus:border-[#004D40] focus:ring-4 focus:ring-[#004D40]/5`}
                  />
                  {errors.email && (
                    <p className="text-[#FF5630] text-xs font-medium ml-1 flex items-center gap-1 mt-1">
                      <AlertCircle className="w-3 h-3" />
                ...
                {/* Phone */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="phone" className="text-[18px] font-[500] text-[#1A1A1A] ml-1">
                    Phone Number
                  </label>
                  <input
                    id="phone"
                    ...
                    className={`rounded-xl border ${errors.phone ? "border-[#FF5630]" : "border-gray-200"} bg-white px-5 py-4 text-base text-[#1A1A1A] placeholder-[#919EAB] outline-none transition-all focus:border-[#004D40] focus:ring-4 focus:ring-[#004D40]/5`}
                  />
                  {errors.phone && (
                    <p className="text-[#FF5630] text-xs font-medium ml-1 flex items-center gap-1 mt-1">
                      <AlertCircle className="w-3 h-3" />
                ...
                {/* Enquiry */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="enquiry" className="text-[18px] font-[500] text-[#1A1A1A] ml-1">
                    Enquiry Type
                  </label>
                  <input
                    id="enquiry"
                    ...
                    onChange={handleChange}
                    placeholder="Enquiry"
                    className="rounded-xl border border-gray-200 bg-white px-5 py-4 text-base text-[#1A1A1A] placeholder-[#919EAB] outline-none transition-all focus:border-[#004D40] focus:ring-4 focus:ring-[#004D40]/5"
                  />
                </div>

                {/* Message */}
                <div className="flex flex-col gap-2 md:col-span-2">
                  <label htmlFor="message" className="text-[18px] font-[500] text-[#1A1A1A] ml-1">
                    Message
                  </label>
                  <textarea
                    id="message"
                    ...
                    placeholder="Message"
                    rows={6}
                    className={`resize-none rounded-xl border ${errors.message ? "border-[#FF5630]" : "border-gray-200"} bg-white px-5 py-4 text-base text-[#1A1A1A] placeholder-[#919EAB] outline-none transition-all focus:border-[#004D40] focus:ring-4 focus:ring-[#004D40]/5`}
                  />
                  {errors.message && (
                    <p className="text-[#FF5630] text-xs font-medium ml-1 flex items-center gap-1 mt-1">
                      <AlertCircle className="w-3 h-3" />
              ...
              <div className="mt-12 flex flex-col items-center gap-4">
                <Button
                  ...
                  className="w-full max-w-[572px] rounded-[8px] bg-[#004C48] py-4 text-lg font-bold text-white shadow-xl shadow-[#004D40]/20 transition-all hover:bg-[#003632] active:scale-95 disabled:opacity-70"
                >
          ...
          <div className="grid gap-8 md:grid-cols-3">
            ...
            >
              ...
              <div className="mt-auto pt-4 space-y-2">
                ...
                <p className="text-sm font-bold text-[#1A1A1A]">
                  Email:{" "}
                  <a href="mailto:support@Anvila.ai" className="text-[#004D40] hover:underline">
                    support@Anvila.ai
                  </a>
                </p>
              </div>
            ...
            >
              ...
              <div className="mt-auto pt-4">
                <p className="text-sm font-bold">
                  Email:{" "}
                  <a href="mailto:partners@Anvila.ai" className="text-white/80 hover:text-white hover:underline">
                    partners@Anvila.ai
                  </a>
                </p>
              </div>
            ...
            >
              ...
              <div className="mt-auto pt-4">
                <p className="text-sm font-bold text-[#1A1A1A]">
                  Email:{" "}
                  <a href="mailto:press@Anvila.ai" className="text-[#004D40] hover:underline">
                    press@Anvila.ai
                  </a>
                </p>
              </div>
      ...
      {social.svg}
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-10 md:gap-4 lg:col-span-7">
              {Object.entries(footerLinks).map(([title, links]) => (
                <div key={title} className="flex flex-col gap-6 md:gap-8">
                  <h4 className="text-[15px] md:text-[16px] font-bold text-white tracking-wide">{title}</h4>
          ...
          <div className="flex flex-col items-center justify-between gap-8 text-sm md:text-base md:flex-row">
            ...
            <div className="flex flex-wrap items-center justify-center gap-6 md:gap-10 text-[#E7E7E7]">
              <Link href="#" className="transition-colors hover:text-white font-medium">Privacy Policy</Link>
              <div className="hidden md:block h-1.5 w-1.5 rounded-full bg-[#E7E7E7]" />
              <Link href="#" className="transition-colors hover:text-white font-medium">Terms of service</Link>
              <div className="hidden md:block h-1.5 w-1.5 rounded-full bg-[#E7E7E7]" />
              <Link href="#" className="transition-colors hover:text-white font-medium">Cookies Policy</Link>
            </div>
          </div>
        </div>
      </footer>
