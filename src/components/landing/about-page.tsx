            ...
            <div className="grid items-center gap-12 md:gap-24 lg:grid-cols-2">
              ...
              >
                ...
                <p className="text-base md:text-[18px] leading-relaxed font-[400] text-[#000000]">
                  ...
                  generation of AI Agents. We&apos;ve built the
            ...
            {[
              {
                ...
                desc: "We replace messy, inconsistent prompts with a clean, GitHub ready file protocol.",
                bg: "bg-[#F8FAFB]",
                text: "text-[#000000]",
                sub: "",
              },
              {
                ...
                desc: "Through our Public Registry, we empower a global community to share and build upon the world's best AI blueprints.",
                bg: "bg-[#004D40]",
                text: "text-white",
                sub: "shadow-2xl shadow-[#004D40]/30",
              },
              {
                title: "Professional Reliability",
                desc: "We treat AI Agents as digital employees. By standardizing their 'Instruction Manuals,' we ensure they remain reliable tools.",
                bg: "bg-[#F8FAFB]",
                text: "text-[#637381]",
                sub: "",
              },
              ...
              >
                <h3 className="mb-4 md:mb-6 text-xl font-[600]">
                  {card.title}
                </h3>
          ...
          <div className="mb-16 md:mb-24 grid grid-cols-1 gap-12 lg:grid-cols-12">
            <div className="lg:col-span-5">
              <Link href="/" className="mb-6 md:mb-8 flex items-center gap-3">
                ...
                <span className="text-xl md:text-[24px] font-[700] tracking-[0.05em]">
                  ANVILA
                </span>
              </Link>
            ...
            <div className="grid grid-cols-2 gap-8 md:grid-cols-3 lg:col-span-7">
              {Object.entries(footerLinks).map(([title, links]) => (
                <div key={title}>
                  <h4 className="mb-4 md:mb-5 text-sm md:text-[16px] font-[700] text-[#E7E7E7]">
                    {title}
                  </h4>
                  <ul className="space-y-3 md:space-y-5">
                    {links.map((link) => (
                      <li key={link.name}>
                        <Link
                          href={link.href}
                          className="text-xs md:text-[16px] text-[#E7E7E7] transition-colors hover:text-white"
                        >
                          {link.name}
                        </Link>
                      </li>
